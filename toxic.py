...
class HyperlinkExtractor(QMainWindow):
    def __init__(self):
        ...
        # Use a list to store detected hyperlinks, preserving insertion order.
        self.links = []
        ...
        layout.addWidget(QLabel("Detected Hyperlinks:"))
    ...
    def check_clipboard(self):
        """Polls the clipboard for new content and processes HTML if available."""
    ...
    def process_html(self, html):
        ...
        This regex finds values within href="..." or href='...'.
        """
        pattern = r'href=[\'"]([^\'" >]+)'
    ...
    def update_list_widget(self):
        """Updates the list widget with the current list of hyperlinks."""
    ...
    def reset_links(self):
        """Clears the stored links and updates the list widget."""
        self.links = []
        self.list_widget.clear()
